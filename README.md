...
```
ㆍ 각 스케줄링 알고리즘은 JFrame 클래스를 상속받아 paint() 메소드를 오버라이딩한 후 간트 차트를 출력하는 형식을 취하고 있다.   
...
ㆍ 사용자로부터 5개의 프로세스에 대해 도착시간과 버스트시간을 입력받은 후의 FCFS 스케줄링 알고리즘을 실행한 결과이다.   
...
ㆍ 사용자로부터 5개의 프로세스에 대해 도착시간과 버스트시간을 입력받은 후의 Non-Preemptive SJF 스케줄링 알고리즘을 실행한 결과이다.   
ㆍ 프로세스별 대기시간과 반환시간 등의 정보가 잘 출력되고 있음을 알 수 있다.   
...
ㆍ 사용자로부터 5개의 프로세스에 대해 도착시간과 버스트시간을 입력받은 후의 Preemptive SJF 스케줄링 알고리즘을 실행한 결과이다.   
ㆍ 프로세스별 대기시간과 반환시간 등의 정보가 잘 출력되고 있음을 알 수 있다.   
...
```
ㆍ Round Robin 스케링의 대기시간을 구하는 알고리즘이다.   
...
ㆍ 사용자로부터 5개의 프로세스에 대해 도착시간과 버스트시간을 입력받은 후의 Round Robin 스케줄링 알고리즘을 실행한 결과이다.   
ㆍ 프로세스별 대기시간과 반환시간 등의 정보가 잘 출력되고 있음을 알 수 있다.   
...
ㆍ 도착시간을 고려하지 않고 구현한 Round Robin 스케줄링은 형평성을 위해 테스트 과정에서 제외 하였다.   
...
ㆍ 대기 시간이 스케줄링 알고리즘에 실질적으로 영향 받는 요소임을 고려한다면, FCFS, Non-Preemptive SJF, Preemptive SJF 순으로 성능이 좋아지고 있다는 것을 확인 할 수가 있다.   
...
ㆍ FCFS 스케줄링과 마찬가지로 비선점형 정책을 사용하기 때문에 여전히 CPU의 활용도가 떨어진다는 특성을 가지고 있다.   
...
ㆍ 선점형 정책을 사용하기 때문에 CPU 활용도가 좋으며, 앞서 설명한 두 가지 스케줄링 기법에 비해 최소한의 평균 대기시간을 제공해주고 있다.   
ㆍ 프로세스의 선점과 같은 여러 상황을 고려해야하기 때문에 구현하기가 가장 까다로웠던 스케줄링 기법이었다.   

**4) Round Robin Scheduling**   
ㆍ 각 프로세스가 Time Quantum이라 불리는 시간의 양 의해 제한되어 실행된다는 특성을 가진 스케줄링 기법이다.   
...
-----
## 11. 프로젝트를 마치고 느낀 점
* 각 스케링 알고리즘을 직접 구현함으로써 각 스케줄링의 특성을 정확하게 파악할 수 있었고 동작방식을 정확히 이해할 수 있었다.
